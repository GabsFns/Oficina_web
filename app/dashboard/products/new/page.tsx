        ...
        <div className="flex items-center gap-6">
          ...
          <div>
            <div className="flex items-center gap-2 mb-1">
              ...
              <p className="text-yellow-500 text-[9px] font-black uppercase tracking-[0.4em]">Engine Database / SKU-Register</p>
            </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-12">
        ...
        <div className="xl:col-span-7 space-y-8">
          ...
          <section className="bg-[#0d0d0e] border border-white/5 rounded-[2.5rem] p-10 space-y-8">
            <div className="flex items-center gap-3 border-b border-white/5 pb-6">
              ...
              <h2 className="text-xl font-black italic uppercase tracking-tight">Especificações de Base</h2>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                <label className="text-[10px] font-black text-gray-500 uppercase tracking-widest ml-1">SKU / Código do Fabricante</label>
                <input 
                  type="text" 
                  placeholder="EX: ZF-9901-TRX"
              ...
              <div className="space-y-2">
                <label className="text-[10px] font-black text-gray-500 uppercase tracking-widest ml-1">Nome Técnico do Item</label>
                <input 
                  type="text" 
              ...
              <div className="space-y-2">
                <label className="text-[10px] font-black text-gray-500 uppercase tracking-widest ml-1">Marca / OEM</label>
                <select className="w-full bg-black/40 border border-white/10 rounded-xl py-4 px-5 text-sm font-bold uppercase focus:border-yellow-500/50 focus:outline-none transition-all appearance-none"
                  onChange={(e) => setFormData({...formData, brand: e.target.value})}>
                  <option value="">Selecione a Marca</option>
                  <option value="ZF">ZF Aftermarket</option>
                  <option value="EATON">Eaton Fuller</option>
                  <option value="SACHS">Sachs / Mann</option>
                </select>
              </div>
              <div className="space-y-2">
                <label className="text-[10px] font-black text-gray-500 uppercase tracking-widest ml-1">Categoria de Sistema</label>
                <input 
                  type="text" 
          ...
          <section className="bg-[#0d0d0e] border border-white/5 rounded-[2.5rem] p-10 space-y-8">
            <div className="flex items-center gap-3 border-b border-white/5 pb-6">
              ...
              <h2 className="text-xl font-black italic uppercase tracking-tight">Comercial & Aplicação</h2>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                <label className="text-[10px] font-black text-gray-500 uppercase tracking-widest ml-1">Preço de Venda (R$)</label>
                <div className="relative">
                  <span className="absolute left-5 top-1/2 -translate-y-1/2 text-gray-600 font-bold text-sm">R$</span>
                  <input 
                    type="number" 
              ...
              <div className="space-y-2">
                <label className="text-[10px] font-black text-gray-500 uppercase tracking-widest ml-1">Compatibilidade Master</label>
                <input 
                  type="text" 
                  placeholder="EX: VOLVO FH / MAN TGX"
                  className="w-full bg-black/40 border border-white/10 rounded-xl py-4 px-5 text-sm font-bold uppercase focus:border-yellow-500/50 focus:outline-none transition-all"
        ...
        <div className="xl:col-span-5 space-y-8">
          ...
          <div className="bg-[#0d0d0e] border border-white/5 rounded-[2.5rem] p-10 flex flex-col items-center justify-center text-center group cursor-pointer hover:border-yellow-500/30 transition-all border-dashed border-2">
            ...
            <h3 className="text-sm font-black uppercase tracking-widest mb-1">Mídia do Ativo</h3>
            <p className="text-[10px] text-gray-600 font-bold uppercase tracking-tighter">Arraste fotos técnicas ou laudos em PDF</p>
          </div>
          ...
          <div className="space-y-4">
             <div className="flex items-center gap-2 ml-4">
                ...
                <span className="text-[9px] font-black text-gray-500 uppercase tracking-widest">Live Preview do Catálogo</span>
             </div>
             ...
             <div className="bg-gradient-to-br from-[#121214] to-[#0d0d0e] border border-white/10 rounded-[2.5rem] p-8 opacity-90 shadow-2xl">
                <div className="flex justify-between items-start mb-10">
                   ...
                   <div className="text-right">
                      <span className="text-[10px] font-black text-gray-600 uppercase tracking-widest block">Status Auto</span>
                      <span className="text-[10px] font-black text-green-500 uppercase tracking-widest">Aguardando Estoque</span>
                   </div>
                </div>

                <div className="space-y-1 mb-8">
                   <p className="text-[10px] font-black text-yellow-500 uppercase tracking-[0.3em]">{formData.brand || "FABRICANTE"}</p>
                ...
                <div className="grid grid-cols-2 gap-4 border-t border-white/5 pt-8">
                   <div>
                      <span className="text-[8px] font-black text-gray-600 uppercase tracking-widest block mb-1">SKU Master</span>
                      <span className="text-sm font-mono font-bold text-white">{formData.sku || "---"}</span>
                   </div>
                   <div>
                      <span className="text-[8px] font-black text-gray-600 uppercase tracking-widest block mb-1">Preço Sugerido</span>
                      <span className="text-sm font-mono font-black italic text-yellow-500">R$ {formData.price.toLocaleString('pt-BR')}</span>
                   </div>
                </div>
             </div>
          </div>
          ...
          <div className="bg-yellow-500/5 border border-yellow-500/10 rounded-[2rem] p-8 flex items-start gap-4">
             ...
             <p className="text-[11px] text-gray-400 font-medium leading-relaxed italic">
               Dica: O SKU é indexado globalmente. Certifique-se de que o código segue o padrão da montadora para facilitar a integração com o catálogo da ZF ou Eaton.
             </p>
          </div>
        </div>
      </div>
