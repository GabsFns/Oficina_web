...
import toast, { Toaster } from "react-hot-toast"; // Importe o Toaster aqui
...
export default function LoginPage() {
  ...
  return (
    <main className="min-h-screen flex items-center justify-center bg-[#0a0a0b] text-white p-6 font-sans">
      {/* 1. Adicione o Toaster aqui para ele renderizar os alertas */}
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            <div className="group">
              ...
              <input
                ...
                className="w-full bg-[#1a1a1e] border border-white/5 rounded-xl px-4 py-4 outline-none focus:border-yellow-500 transition-all text-sm mt-1"
              />
            </div>
            ...
            <button 
              type="submit"
              disabled={loading}
              className={`w-full bg-yellow-600 hover:bg-yellow-500 py-4 rounded-xl font-semibold transition-all shadow-lg shadow-yellow-900/20 active:scale-[0.98] mt-4 ${loading ? 'opacity-50 cursor-not-allowed' : ''}`}
            >
